		...
		<fieldset>
			...
			<table>
				...
				<shiro:hasRole name="admin">
					<tr>
						<td>Access Level :</td>
						<td><select name="role" id="role" ng-model="role"
							set-value="<c:out value="${user.getInfo(\"role\")}"/>">
				...
				<tr>
					...
					<td><select name="gender" id="gender" ng-model="gender"
						...
						ng-change="salutation=salutations[gender][0]"
						set-value="<c:out value="${user.getInfo(\"gender\")}"/>" required>
					</select></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td><select name="salutation" id="salutation"
						ng-model="salutation"
						ng-options="o as o for o in salutations[gender] track by o"
						set-value="<c:out value="${user.getInfo(\"salutation\")}"/>"
						required></select></td>
				</tr>
				<tr>
					<td></td>
